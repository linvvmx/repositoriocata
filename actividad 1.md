...
| Registro VPN                     |  dato                             | El registro de VPN muestra una conexión nocturna desde una   | Guardar registro de VPN para luego indagar.
|                                  |                                   | dirección IP no habitual.                                    |                                                                 |
| Fotografía                       |   evidencia/indicio               | Fotografia con evidencia de una aplicacion abierta de acceso | Guardar la fotografia.
|                                  |                                   | remoto que no recuerda haber instalado.                      |                                                                 |
| Archivo ZIP                      |    evidencia                      | En descargas aparece un archivo zip llamado `actualizacion.zip`.| Guardar copia del archivo sin meterse o modificar el original.
|                                  |                                   |                                                              |
| Hash SHA-256                     |     dato                          | Hash calculado sobre una copia del archivo zip.               |  Evitar abrirlo desde equipo original.
                                                                                                                            
| Comentario del supervisor        |      opinion/hipotesis            | Supervisor "asegura" que fue Camila.                         | Registrar sus palabras con fecha y contexto.   


## Tres preguntas para conversar

1. ¿La fotografía o el registro demuestran quién controlaba la cuenta? ¿Por qué?: No, ya que con solo una ip no siempre se puede saber quien es de el culpable.
2. ¿Qué podría cambiar si abrimos el ZIP directamente en el equipo original?: Podria modificarse o dañarse el contenido importante.
3. ¿Qué acción requeriría autorización adicional?: Revisar actividad de Camila e instalaciones recientes o cercanas a la hora dicha.

Complete tres frases breves:

- Una evidencia digital es informacion importante que se puede utilizar si esta no esta modificada.
- Antes de analizar, debemos detectar una fuente.
- Sobre el equipo original evitaría modificar, abrir archivos o apagar equipo porque la evidencia podria verse afectada.
